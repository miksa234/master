...
\begin{align}
    |f'(\tilde{\delta}) - f'(\tilde{\delta}^{*})| \le \frac{1}{4}
    |f'(\tilde{\delta}^{*})|
\end{align}
holds for all $\tilde{\delta}$ in the epsilon ball. Then by the mean value
theorem and Lipschitz continuity
\begin{align}
    ...
    |\tilde{\delta} - \tilde{\delta}^{*}| = \frac{1}{2c} |\tilde{\delta} - \tilde{\delta}^{*}|
\end{align}
Then for $\tilde{\delta}_0 $ in the epsilon ball the first iterate is also in
the ball
\begin{align}
...
derivatives are not zero and the iterates converge to $\tilde{\delta}^{*}$ as
