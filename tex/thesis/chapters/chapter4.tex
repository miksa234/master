\chapter{Finding a Quasioptimal N-Cyclic Arbitrage Walk with MCTS based
REINFORCE}
\begin{enumerate}
    ...
    \item Results
\end{enumerate}
TODO: ALL OF THIS NEEDS TO BE CHANGED TO REINFORCE

This chapter will go through the RL framework \& neural network model used
...
\section{Deep Graph Neural Network}
